...
public class ChartsActivity extends AppCompatActivity {
    ...
    private void initCharts() {
        ...
        axisXDoneChart.setLineColor(lineColor);
        axisXDoneChart.setTextColor(textColor);
        ...
        axisXUndoneChart.setLineColor(lineColor);
        axisXUndoneChart.setTextColor(textColor);
