...
public class ChartsActivity extends AppCompatActivity {
    ...
    private void initCharts() {
        ...
        axisY.setTextColor(ContextCompat.getColor(ChartsActivity.this, R.color.gray_textColorHigh));
        ...
        axisXDoneChart.setTextColor(ContextCompat.getColor(ChartsActivity.this, R.color.gray_textColorHigh));
        ...
        axisXUndoneChart.setTextColor(ContextCompat.getColor(ChartsActivity.this, R.color.gray_textColorHigh));
